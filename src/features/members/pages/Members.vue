    ...
    <template #more>
      <div class="flex items-center justify-end  rounded-lg border-2 border-[#3C3C9E]">
        ...
        <button
          ...
          role="tab" aria-selected="false" id="tab-quotation" aria-controls="panel-quotation">
          Quotation Drafts
        </button>
        <button
          ...
          role="tab" aria-selected="false" id="tab-account" aria-controls="panel-account">
          Account Created
        </button>
      </div>
