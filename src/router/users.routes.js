export default [
  ...
  { path: '/dispersementDetails/:despersementUuid', name: 'DespersementDetails', component: () => import('@/features/financing/dispersement/pages/dispersementDetails.vue'), meta: { requiresAuth: true, permissions: [] } },
]
